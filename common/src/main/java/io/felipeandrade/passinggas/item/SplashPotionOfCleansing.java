...
//
//public class SplashPotionOfCleansing extends Item {
//
//    public SplashPotionOfCleansing(Settings settings) {
//        super(settings);
//    }
//
...
//        if (!world.isClient) {
//            PotionEntity potionEntity = new PotionEntityOfCleansing(world, user);
